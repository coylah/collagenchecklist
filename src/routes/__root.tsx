...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Collagen Checklist — Age Slow & Glow. Love Coylah." },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "The Collagen Checklist — Age Slow & Glow. Love Coylah." },
      ...
      { name: "twitter:title", content: "The Collagen Checklist — Age Slow & Glow. Love Coylah." },
